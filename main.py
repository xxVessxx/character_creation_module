...
def attack(char_name: str, char_class: str) -> str:
    """Функция рассчитывает, сколько урона нанёс персонаж."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция рассчитывает, сколько урона заблокировал персонаж."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция показывает результат применения специального умения."""
    if char_class == 'warrior':
